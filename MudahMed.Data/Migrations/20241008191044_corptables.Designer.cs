...
namespace MudahMed.Data.Migrations
{
    ...
    [Migration("20241008191044_corptables")]
    partial class corptables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MudahMed.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "3c4ece07-afd5-43e3-801c-5626c8c10dc9",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "852d45f4-d9ca-481f-b519-28d0f1ce4e50",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "6f0dc847-71e5-4755-9b9a-d543fb0b9208",
            ...
            modelBuilder.Entity("MudahMed.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e372659a-8364-4bd4-a7d9-0d24c35e7c5a",
                            CreateDate = new DateTime(2024, 10, 9, 3, 10, 43, 106, DateTimeKind.Local).AddTicks(4733),
                            Disable = false,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEIPwE0Laft17NMMQyqp+ZnsxCeuHXECSjtGGI89a8k8m23/zLQYiilWwZawlC+opNg==",
            ...
            modelBuilder.Entity("MudahMed.Data.Entities.Blog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MudahMed.Data.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MudahMed.Data.Entities.Corp", b =>
                {
                    ...
                    b.Property<string>("CorpAddr1")
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");

                    b.Property<string>("CorpAddr2")
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");

                    b.Property<string>("CorpAddr3")
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");

                    b.Property<string>("CorpContactNo")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("CorpFax")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.Property<string>("CorpRegNo")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("CorpTIN")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("MudahMed.Data.Entities.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MudahMed.Data.Entities.CV", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MudahMed.Data.Entities.Job", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MudahMed.Data.Entities.Province", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MudahMed.Data.Entities.Skill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MudahMed.Data.Entities.Time", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MudahMed.Data.Entities.Title", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JobSkill", b =>
                {
                    b.HasOne("MudahMed.Data.Entities.Job", null)
                        .WithMany()
                        .HasForeignKey("JobsId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MudahMed.Data.Entities.Skill", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MudahMed.Data.Entities.AppUser", b =>
                {
                    b.HasOne("MudahMed.Data.Entities.Category", null)
                        .WithMany("AppUsers")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("MudahMed.Data.Entities.Country", "Country")
                        .WithMany("AppUsers")
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("MudahMed.Data.Entities.Province", "Province")
                        .WithMany()
            ...
            modelBuilder.Entity("MudahMed.Data.Entities.Blog", b =>
                {
                    b.HasOne("MudahMed.Data.Entities.AppUser", "AppUser")
                        .WithMany()
            ...
            modelBuilder.Entity("MudahMed.Data.Entities.CV", b =>
                {
                    ...
                    b.HasOne("MudahMed.Data.Entities.Job", "Job")
                        .WithMany("CVs")
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("MudahMed.Data.Entities.Job", b =>
                {
                    ...
                    b.HasOne("MudahMed.Data.Entities.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("MudahMed.Data.Entities.Time", "Time")
                        .WithMany("Jobs")
                        .HasForeignKey("TimeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MudahMed.Data.Entities.Title", "Title")
                        .WithMany("Jobs")
