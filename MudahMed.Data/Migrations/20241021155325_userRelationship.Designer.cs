...
namespace MudahMed.Data.Migrations
{
    ...
    [Migration("20241021155325_userRelationship")]
            ...
            modelBuilder.Entity("MudahMed.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "d59d9765-d884-4842-ae8e-78f0457b4a95",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "09565143-16a5-4109-8ced-051e4d7d7794",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "304364c2-26dc-4250-83e2-7a073eeba12f",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "e19750ee-1457-4bbb-b14e-f87a96a7eab1",
            ...
            modelBuilder.Entity("MudahMed.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "5a388e0d-77e3-47ed-8f01-580996330ef4",
                            CreatedDate = new DateTime(2024, 10, 21, 23, 53, 24, 321, DateTimeKind.Local).AddTicks(6572),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEDcLhRbkDFNenVwOxs2qm0D1tS18IG78h6gNiD9eLboCBglp2/tK2cez6tDXzdl1Vg==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "cc7e80ea-53a3-4da9-84c8-9497c77b90a2",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEKIhHCgvh8DGtxxzCQsFuBJsX6wG0nEQD5e1mA82gBC7RSTh7IRVqOlLlPloxpSy1w==",
                            PhoneNumberConfirmed = false,
                            RefId = 1,
                            RefTable = "tblCorp",
                            SecurityStamp = "",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3ffcc3ed-3ec3-48f7-9f8f-85c6be4a70b8",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEEHjbUmnZj+KmPnVHE1Hi+g6HOO1Vkbt6XWa3T8B3q+o3mJGEEunNGZtFzwuVwR9eg==",
                            PhoneNumberConfirmed = false,
                            RefId = 1,
                            RefTable = "tblClinic",
                            SecurityStamp = "",
            ...
            modelBuilder.Entity("MudahMed.Data.Entities.Corp", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IndustryField = 1,
                            IsSuspend = false,
                            LastModifiedDate = new DateTime(2024, 10, 21, 23, 53, 24, 319, DateTimeKind.Local).AddTicks(7971),
                            createdDate = new DateTime(2024, 10, 21, 23, 53, 24, 319, DateTimeKind.Local).AddTicks(7970)
                        });
                });
            ...
            modelBuilder.Entity("MudahMed.Data.Entities.CorpGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CorpGroupID = 1,
                            BankID = 1,
                            LastModifiedDate = new DateTime(2024, 10, 21, 23, 53, 24, 319, DateTimeKind.Local).AddTicks(7946),
                            Name = "MudahMed Group",
                            createdDate = new DateTime(2024, 10, 21, 23, 53, 24, 319, DateTimeKind.Local).AddTicks(7933)
                        });
                });
