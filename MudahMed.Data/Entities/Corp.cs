...
namespace MudahMed.Data.Entities
{
    public class Corp
    {
        ...
        [Display(Name = "Bank")]
        public Bank Bank { get; set; } // Navigation property to the bank associated with the corporation

        [Display(Name = "Corporate Group")]
        public virtual CorpGroup CorpGroup { get; set; } // Navigation property to the corporate group that the corporation belongs to
